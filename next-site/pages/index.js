      ...
      <main className="pt-20"> {/* Added padding-top to account for fixed navbar */}
        <section className="py-20 text-center bg-gradient-to-b from-blue-50 to-white">
          <div className="container mx-auto px-4">
            <h1 className="text-5xl font-bold mb-6 text-gray-900">IA e Transformação Digital,<br />sem fumaça. Resultados reais.</h1>
            <p className="text-xl mb-8 text-gray-600 max-w-2xl mx-auto">Sou Eduardo Prado. Traduzo dados e IA em impacto mensurável para negócios e setor público.</p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="p-8 border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition bg-white">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">Consultoria &amp; Pilotos de IA</h3>
                <p className="text-gray-600">Mapeamos oportunidades e executamos pilotos para gerar valor em semanas, não meses.</p>
              </div>
              <div className="p-8 border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition bg-white">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">Palestras &amp; Workshops</h3>
                <p className="text-gray-600">Conteúdo sob medida para líderes que precisam decidir sem hype e com embasamento.</p>
              </div>
              <div className="p-8 border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition bg-white">
                ...
                <h3 className="text-xl font-bold mb-3 text-gray-900">Mentorias &amp; Advisory</h3>
                <p className="text-gray-600">Acompanhamento direto para acelerar seu aprendizado e a execução da sua estratégia.</p>
              </div>
            </div>
          </div>
        </section>
